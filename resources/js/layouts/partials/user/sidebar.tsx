    ...
    return (
        <aside className={asideClassName}>
            ...
            <div className="mt-auto border-t border-gray-200 px-4 pt-[17px] pb-4">
                <Link
                    href="#"
                    className="flex h-12 w-full items-center gap-3 rounded-lg pl-4 text-slate-600 hover:bg-slate-100"
                >
                ...
                <button
                    ...
                    className="mt-1 flex h-12 w-full items-center gap-3 rounded-lg pl-4 text-slate-600 hover:bg-slate-100"
                >
